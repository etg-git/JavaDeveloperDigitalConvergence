...
public class InformationForm extends JDialog implements ActionListener {
	...
	private void init() {
		...
		TitledBorder tBorder = new TitledBorder(new LineBorder(Color.GRAY, 1), "Check your Information");
	...
	private void logout() {
		int result = JOptionPane.showConfirmDialog(this, "logout: are you sure?", "Question", JOptionPane.YES_NO_OPTION,
	...
	private void withdraw() {
		...
		if (result == JOptionPane.YES_OPTION) {
			...
			String msg = "good bye~";
			boolean isCorrect = password.equals(user.getUid());
			if (!isCorrect) {
				msg = "wrong password";
			}
