class StarCraftTribeTest {
	public static void main(String[] args) {
		//저그 String name, int hp, double moveSpeed, String tribe, int power, String attType
		//테란 String name, int hp, double moveSpeed, String tribe, int heal, int energy
		//프로토스 String name, int hp, double moveSpeed, String tribe, int power, String attType, int shield
		Zealot z1 = new Zealot("질럿", 100, 1.875, "프로토스", 16, "지상", 60);
		Zealot z2 = new Zealot("질럿", 100, 1.875, "프로토스", 16, "지상", 60);
		...
		System.out.println();
		Mutallisk mt = new Mutallisk("뮤탈리스크", 120, 3.126, "저그", 9, "공중");
